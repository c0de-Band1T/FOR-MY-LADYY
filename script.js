const welcomeTexts = [
  { main: "a small message from me", sub: "this itself cant hold much that i wanna say, but will try at fullest." },
  { main: "My Love", sub: "Thank you for being a part of my life." }
];
...
const songs = {
  perfect: { url: "myAudio/wannabeyours.mp3", title: "I wanna be yours" },
  thousand: { url: "myAudio/golden.mp3", title: "Golden brown" },
  allofme: { url: "myAudio/aakhiya.mp3", title: "Aakhiya - mitraz" }
};
